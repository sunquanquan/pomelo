...
ChannelHandler.prototype.send = function(msg, session, next) {
	var scope, content, message, channelName, gameID, code;
	...
	content = {playerId: playerId, gameID: gameID, content: msg.content, scope: scope, kind: msg.kind || 0, from: msg.from};
	if (scope !== SCOPE.PRI) {
